...
= 1.4.5 =
* Remove all plugz options on plugz plugin uninstall

= 1.4.4 =
* Minor improvements on plugz plugin install/uninstall
...
= 1.4 =
* Fixes widget preview with long custom css bug

= 1.3.6 =
* Fixes monetize and gay widget preview bugs
...
= 1.3.2 =
* Reindex speedup, minor fixes, widget improvements

= 1.3.1 =
* Minor php warning bug fix

= 1.3 =
* An important image indexing bug was fixed.
