                                ...
                                <div id="slidingContent" style=
                                    ...
                                    <div class="widgetcontent">
                                        ...
                                        <fieldset>
                                            ...
                                            <div data-widget-id="" class="widget_settings">
                                                <p>
                                                    <label class="control-label" for="widget_placement">Widget Placement</label>
                                                    <span><select id="widget_placement" class="widget_placement" name="widget_placement[<?php echo $widget['id'] ?>]">
                                                            <option value="on all posts">on all posts:</option>
                                                            <option value="on all pages">on all pages:</option>
                                                            <option value="on all posts and pages">on all posts and pages:</option>
                                                            <option value="on single post">on single post:</option>
                                                            <option value="on single page">on single page:</option>
                                                            <option value="in sidebar">in sidebar</option>
                                                        </select>
                                                    </span>
                                                <div style="margin-top:10px;margin-left:20px" class="in_sidebar_notice" id="in_sidebar_notice_<?php echo $widget['id'] ?>">
                                                    In order to place your widget to a sidebar: <ol style="margin-top:10px;margin-left:20px"><li>go to your <a href="/wp-admin/widgets.php">WP's Widget menu</a> and drag <b>Plugz Widget</b> to one of your sidebars and</li><li>select the widget you wish to add to the sidebar.</li></ol>
                                                </div>
                                                </p>
                                                <p class="widget_page_id" id="widget_page_id_<?php echo $widget['id'] ?>">
                                                    <label class="control-label" for="widget_page_id">Page</label>
                                                    <span><select id="widget_page_id" name="widget_page_id[<?php echo $widget['id'] ?>]">
                                                            <?php
                                                ...
                                                <p class="widget_post_id" id="widget_post_id_<?php echo $widget['id'] ?>">
                                                    <label class="control-label" for="widget_post_id">Page</label>
                                                    <span><select id="widget_post_id" name="widget_post_id[<?php echo $widget['id'] ?>]">
                                                            <?php
                                                ...
                                                <p class="widget_after_paragraph" id="widget_after_paragraph_<?php echo $widget['id'] ?>">
                                                    <label class="control-label" for="widget_after_paragraph_select">Paragraph</label>
                                                    <span><select id="widget_after_paragraph_select" class="widget_after_paragraph_select" name="widget_placement_paragraph[<?php echo $widget['id'] ?>]">
                                                            <option value="bottom">bottom</option>
                                                            <option value="1">after 1st paragraph</option>
                                                            <option value="2">after 2nd paragraph</option>
                                                            <option value="3">after 3rd paragraph</option>
                                                            <option value="4">after 4th paragraph</option>
                                                            <option value="5">after 5th paragraph</option>
                                ...
                                <div class="widgetbox" style=
                                    ...
                                    <div class="widgetcontent" style=
                                        ...
                                        <div class="slimScrollDiv" style=
                                            ...
                                            <div id="widgetTemplates" class="mousescroll">
                                                <ul class="entrylist">
                                                    <li data-imageyn="1" data-widget_width="300" data-imagenumber="6" data-imagetype="sqau" data-padding="5" data-border="1" data-imgwidth="140" data-textalign="center" data-letternum="60" data-hide_widgetbox_custom_css="1">
                                                        <div class="entry_wrap clearfix">
                                                            <div class="entry_img"><img src="<?php echo PLUGZ_IMAGE_DIR ?>/template1.png" alt="" /></div>
                                                            <div class="entry_content">
                                                                <h4>Template 1</h4>
                                                                <div><small><strong>Image: </strong>6</small></div>
                                                                <div><small><strong>Text: </strong>under the image</small></div>
                                                                <div><small><strong>Widget Width: </strong>300px</small></div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="even" data-imageyn="0" data-widget_width="320" data-imagenumber="4" data-imagetype="sqau" data-padding="5" data-border="1" data-imgwidth="140" data-textalign="left" data-letternum="60" data-hide_widgetbox_custom_css="1">
                                                        <div class="entry_wrap clearfix">
                                                            <div class="entry_img"><img src="<?php echo PLUGZ_IMAGE_DIR ?>/template2.png" alt="" /></div>
                                                            <div class="entry_content">
                                                                <h4>Template 2</h4>
                                                                <div><small><strong>Image: </strong>no</small></div>
                                                                <div><small><strong>Text: </strong>left</small></div>
                                                                <div><small><strong>Widget Width: </strong>320px</small></div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li data-imageyn="1" data-widget_width="250" data-imagenumber="3" data-imagetype="port" data-padding="7" data-border="0" data-imgwidth="250" data-textpos="1" data-textalign="left" data-letternum="60" data-fontcolor="ffffff" data-hovertextcolor="ffffff" data-hide_widgetbox_custom_css="1">
                                                        <div class="entry_wrap clearfix">
                                                            <div class="entry_img"><img src="<?php echo PLUGZ_IMAGE_DIR ?>/template3.png" alt="" /></div>
                                                            <div class="entry_content">
                                                                <h4>Template 3</h4>
                                                                <div><small><strong>Image: </strong>3</small></div>
                                                                <div><small><strong>Text: </strong>on the image</small></div>
                                                                <div><small><strong>Widget Width: </strong>250px</small></div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li class="even" data-imageyn="0" data-sitelink="1" data-widget_width="570" data-imagenumber="10" data-border="0" data-textalign="center" data-fontfamily="Georgia" data-fontsize="16" data-letternum="100" data-titlelength="trimmed" data-hide_widgetbox_custom_css="1">
                                                        <div class="entry_wrap clearfix">
                                                            <div class="entry_img"><img src="<?php echo PLUGZ_IMAGE_DIR ?>/template4.png" alt="" /></div>
                                                            <div class="entry_content">
                                                                <h4>Template 4</h4>
                                                                <div><small><strong>Image: </strong>0</small></div>
                                                                <div><small><strong>Text: </strong>center</small></div>
                                                                <div><small><strong>Widget Width: </strong>320px</small></div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li data-imageyn="1" data-widget_width="300" data-imagenumber="5" data-imagetype="wide" data-padding="5" data-border="1" data-imgwidth="140" data-textalign="left" data-letternum="60" data-textpos="4" data-hide_widgetbox_custom_css="1">
                                                        <div class="entry_wrap clearfix">
                                                            <div class="entry_img"><img src="<?php echo PLUGZ_IMAGE_DIR ?>/template5.png" alt="" /></div>
                                                            <div class="entry_content">
                                                                <h4>Template 5</h4>
                                                    ...
                                                    <li class="even" data-imageyn="1" data-widget_width="470" data-imagenumber="8" data-imagetype="sqau" data-padding="3" data-border="1" data-imgwidth="110" data-textalign="center" data-letternum="60" data-fontweight="bold" data-hide_widgetbox_custom_css="1">
                                                        <div class="entry_wrap clearfix">
                                                            <div class="entry_img"><img src="<?php echo PLUGZ_IMAGE_DIR ?>/template6.png" alt="" /></div>
                                                            <div class="entry_content">
                                                                <h4>Template 6</h4>
                                                                <div><small><strong>Image: </strong>8</small></div>
                                                                <div><small><strong>Text: </strong>under the image</small></div>
                                                                <div><small><strong>Widget Width: </strong>470px</small></div>
                                                            </div>
                                                        </div>
                                                    </li>
...
padding-top:5px;
                                                        ...
                                                        <div class="entry_wrap clearfix">
                                                            ...
                                                            <div class="entry_content">
                                                                ...
                                                                <div><small><strong>Effects: </strong>all capital text, hover, dividing line</small></div>
                                                                <div><small><strong>Widget Width: </strong>390px</small></div>
                                                            </div>
                                                        </div>
                                                    </li>
...
padding-top:10px;
                                                        ...
                                                        <div class="entry_wrap clearfix">
                                                            ...
                                                            <div class="entry_content">
                                                                ...
                                                                <div><small><strong>Effects: </strong>hover, randomly rotated images</small></div>
                                                                <div><small><strong>Widget Width: </strong>420px</small></div>
                                                            </div>
                                                        </div>
                                                    </li>
...
color:#039;
                                                        ...
                                                        <div class="entry_wrap clearfix">
                                                            ...
                                                            <div class="entry_content">
                                                                ...
                                                                <div><small><strong>Effects: </strong>hover, semi-transparent text background</small></div>
                                                                <div><small><strong>Widget Width: </strong>380px</small></div>
                                                            </div>
                                                        </div>
                                                    </li>
...
color:#039;
                                                        ...
                                                        <div class="entry_wrap clearfix">
                                                            ...
                                                            <div class="entry_content">
                                                                ...
                                                                <div><small><strong>Effects: </strong>hover, semi-transparent text background</small></div>
                                                                <div><small><strong>Widget Width: </strong>360px</small></div>
                                                            </div>
                                                        </div>
                                                    </li>
...
color:#039;
                                                        ...
                                                        <div class="entry_wrap clearfix">
                                                            ...
                                                            <div class="entry_content">
                                                                <h4>Custom CSS</h4>
                                                                <div><small><strong>Your Own CSS: </strong>Allows you to create your own css.</small></div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                </ul>                        
                                    ...
                                    <div id="widgetbox_customize" class="widgetbox" style="margin-bottom: 0px;">
                                        <h4 class="widgettitle">Customize Widget <a class="minimize">–</a></h4>

                                        <div class="widgetcontent" style="display: block;">
                                            <div id="widgetbox_widget_settings" class="widgetbox box-inverse">
                                            ...
                                            <div id="widgetbox_image_settings" class="widgetbox box-success">
                                            ...
                                            <div id="widgetbox_text_settings" class="widgetbox box-notice">
                                            ...
                                            <div id="widgetbox_niche_settings" class="widgetbox box-warning">
                                            ...
                                            <div id="widgetbox_custom_css" class="widgetbox box-inverse">
                                                <h4 class="widgettitle">Custom CSS <a class="minimize">&ndash;</a></h4>
                                                <div class="clearfix widgetcontent">
                                                    <p class="row" id="customcss_container">
                                                        <label class="span7">CSS</label>
                                                        <span class="span7 field">
                                                            <textarea data-widearea="enable" class="span12" id="customcss" name="customcss" cols="10" rows="5"></textarea>
                                                        </span>
                                                    </p>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        var ajaxPath = '<?php echo '/wp-admin/admin.php?page=plugz/widgets&noheader=1' ?>';
    </script>
    <script src="<?php echo PLUGZ_JS_DIR ?>/widgetPosition.js" type="text/javascript"></script>
    <script src="<?php echo PLUGZ_JS_DIR ?>/widearea/widearea.min.js" type="text/javascript"></script>
    <script>
            ...
            $('#widgetTemplates .entrylist li').css('cursor', 'pointer').css('cursor', 'hand').click(function(event) {
                ...
                $.each(attrs, function(key, value) {
                    if (key.substr(0, 5) == 'hide_') {
                        $("#" + key.replace('hide_', '')).hide();
                        $("#" + key.replace('hide_', '')).closest('.row').hide();
                    } else {
                        $("#" + key).val(value);
                    }
                });

                $("#textpos, #imageyn").trigger('change');
    ...
    <script src="<?php echo PLUGZ_JS_DIR ?>/jquery.alerts.js" type="text/javascript"></script>
